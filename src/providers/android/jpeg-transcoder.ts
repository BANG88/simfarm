...
// The quality mapping and the JPEG splitter moved to util/mjpeg.ts when the
// iOS scaler started needing them; re-exported so callers keep one import.
export { mjpegQscale, splitJpegs };
